...
public class JwtServiceImpl implements IJWTService {
    ...
    private final UserService userService;private static final Logger logger = LoggerFactory.getLogger(JwtServiceImpl.class);
    ...
    public void  deleteToken(String token){
        ...
        blacklistService.addToBlackList(token,StaticVar.JWT_REFRESH_TOKEN_EXPIRATION);
    }
    ...
    public String generateRefreshToken(User user) {
        return Jwts.builder()
                ...
                .claim("scope",buildScope(user))
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis()+ StaticVar.JWT_REFRESH_TOKEN_EXPIRATION))
                .signWith(getSignKey(), SignatureAlgorithm.HS256)
                .compact();
    }
